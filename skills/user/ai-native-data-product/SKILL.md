...
description: Design standards for AI-native data products on Teradata. Six-module architecture with DDL patterns, agent discovery protocol, and routing intelligence for the ANDP coordinator.
user-invokable: true
---
