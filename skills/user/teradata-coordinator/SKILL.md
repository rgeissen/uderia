...
description: Routing rules and expert delegation instructions for the TDEXP Teradata Expert Coordinator. Defines when to invoke TDSQL, TDDIC, TDADM, and TDEXE.
user-invokable: true
---
...
- Platform skill: `skills/user/teradata-coordinator/` (repo)
...
**To update coordinator instructions:** Edit `skills/user/teradata-coordinator/teradata-coordinator.md` in the repo, then reload via `POST /v1/skills/reload`.
