...
function _renderFullGraph(container, nodes, links, colors, width, height, toolbar) {
    ...
    linkGroup.append('line')
        ...
        .attr('stroke-dasharray', function() { try { return this.getTotalLength(); } catch(e) { return 200; } })
        .attr('stroke-dashoffset', function() { try { return this.getTotalLength(); } catch(e) { return 200; } })
        .transition()
        .delay((d, i) => 300 + i * 30)
        .duration(600)
