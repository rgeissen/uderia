            ...
            <div class="border-t border-white/10 pt-4 mt-4">
                ...
                <div class="whats-new-container">
                    <ul class="list-disc list-inside text-xs text-gray-300 space-y-1">
                       <li><strong>03-May-2026:</strong> Microsoft 365 &amp; Slack Platform Connectors — Connect Outlook, Teams, SharePoint, and Slack via per-user OAuth; the agent can read/send emails, manage calendar events, post channel messages, and browse SharePoint files. Admin configures app credentials once; users connect their own accounts via Platform Components → Connectors.</li>
                       <li><strong>03-May-2026:</strong> Per-User Component Settings — Admins can grant or block access to individual components (Chart, Canvas, Scheduler, Knowledge Graph) per user, independent of global settings and profile-level configuration.</li>
                       <li><strong>02-May-2026:</strong> Continuous Knowledge Sync (CDC) — Repositories stay automatically current across environments. Only changed documents are re-processed; deleted content is removed. Supports portable Source URIs for cross-environment portability and datetime-anchor scheduling for precise sync windows.</li>
